...
func (r *DeviceRepository) StoreAutoReply(reply *domainChatStorage.AutoReply) error {
	return r.base.StoreAutoReply(reply)
}

func (r *DeviceRepository) GetAutoReplies() ([]*domainChatStorage.AutoReply, error) {
	return r.base.GetAutoReplies()
}

func (r *DeviceRepository) GetAutoReply(id int64) (*domainChatStorage.AutoReply, error) {
	return r.base.GetAutoReply(id)
}

func (r *DeviceRepository) DeleteAutoReply(id int64) error {
