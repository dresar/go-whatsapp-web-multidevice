...
func (r *deviceChatStorage) StoreAutoReply(reply *domainChatStorage.AutoReply) error {
	return r.base.StoreAutoReply(reply)
}

func (r *deviceChatStorage) GetAutoReplies() ([]*domainChatStorage.AutoReply, error) {
	return r.base.GetAutoReplies()
}

func (r *deviceChatStorage) GetAutoReply(id int64) (*domainChatStorage.AutoReply, error) {
	return r.base.GetAutoReply(id)
}

func (r *deviceChatStorage) DeleteAutoReply(id int64) error {
	return r.base.DeleteAutoReply(id)
}
